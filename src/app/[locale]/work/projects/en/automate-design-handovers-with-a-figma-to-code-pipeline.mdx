---
title: "Automating Design with OpenAI"
...
team:
  - name: "Priam"
    ...
    linkedIn: "https://www.linkedin.com/company/tuff-inc/"
---

## Overview

In this project, I focused on automating the often tedious design handover process. The goal was to create a pipeline that converts  designs directly into clean, production-ready code. By integrating design tokens, component libraries, and automated workflows, this solution significantly reduced the time spent on translating design assets into code, while maintaining design consistency across the product.

## Key Features

- **Figma Plugin Integration**: Developed a custom Java & Web plugin that extracts design tokens such as colors, typography, and spacing values, and exports them in a format compatible with our codebase.
...
- **OpenAI API**: For extracting design tokens and component data directly from the Open designs.
